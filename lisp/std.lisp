...
(let filter/i std/vector/filter/i)
(let some/i? std/vector/some/i?)
(let every/i? std/vector/every/i?)
...
(let \reduce/i (lambda fn a xs (std/vector/reduce/i xs fn a)))
...
(let Vector->Que (lambda xs (std/convert/vector->deque xs)))
