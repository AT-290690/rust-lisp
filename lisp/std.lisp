...
(let std/int/char/upper (lambda char (if (and (>= char std/int/char/a) (<= char std/int/char/z)) (- char std/int/char/space) char)))
(let std/int/char/lower (lambda char (if (and (>= char std/int/char/A) (<= char std/int/char/Z)) (+ char std/int/char/space) char)))
